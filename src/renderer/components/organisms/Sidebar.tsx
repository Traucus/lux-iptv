...
export type SidebarSection = 'home' | 'live' | 'movies' | 'series' | 'epg' | 'settings';
 ...
 *
 * REQ-NAV-DEAD-BUTTONS: Favorites and Search stay omitted until those slices land.
 */
const NAV_ENTRIES: NavEntry[] = [
  ...
  { key: 'epg', label: 'TV Guide', icon: ICON_EPG },
