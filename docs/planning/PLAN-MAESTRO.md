...
| EPG now/next IPC + live card titles | EPG guide S9 (FA-11); Windows proof of Xtream short EPG (FA-12) |
...
| **F6** | EPG | Guide + now/next on Live, zap to S7 | Now/next in tree. Remaining: S9 guide (FA-11) |
